...
{
juce::Colour const bg = juce::Colour(12, 14, 18);
juce::Colour const grey0 = juce::Colour(46, 52, 64);  // nord0
juce::Colour const grey1 = juce::Colour(59, 66, 82);  // nord1
juce::Colour const grey2 = juce::Colour(67, 76, 94);  // nord2
juce::Colour const grey3 = juce::Colour(76, 86, 106); // nord3
