#include "overdrive_look_and_feel.h"

#include "colors.h"
#include <juce_gui_basics/juce_gui_basics.h>

OverdriveLookAndFeel::OverdriveLookAndFeel()
{
    setColourScheme(getColourScheme());
}

void OverdriveLookAndFeel::drawRotarySlider(
...
void OverdriveLookAndFeel::drawLabel(juce::Graphics& g, juce::Label& label)
{
